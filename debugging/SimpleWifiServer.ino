...
void setup() {
  Serial.begin(115200);
  pinMode(16, OUTPUT);  // 16 = Green LED
      ...
      if (client.available()) {     // if there's bytes to read from the client,
        ...
        if (c == '\n') {            // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("Click <a href=\"/H\">here</a> to turn the LED on pin 16 off.<br>");
            client.print("Click <a href=\"/L\">here</a> to turn the LED on pin 16 on.<br>");
